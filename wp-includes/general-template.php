		...
		if ( 'html5' == $format ) {
			$form = '<form role="search" method="get" class="search-form" action="' . esc_url( home_url( '/' ) ) . '">
				<label>
					...
					<input type="search" class="search-field" placeholder="' . esc_attr_x( 'Nhập từ khóa cần tìm &hellip;', 'placeholder' ) . '" value="' . get_search_query() . '" name="s" title="' . esc_attr_x( 'Tìm kiếm', 'label' ) . '" />
				</label>
			...
			$form = '<form role="search" method="get" id="searchform" class="searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<div>
					<label class="screen-reader-text" for="s">' . _x( 'Tìm kiếm theo từ khóa', 'label' ) . '</label>
